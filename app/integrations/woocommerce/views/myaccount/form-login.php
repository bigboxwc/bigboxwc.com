	...
	<form class="col align-self-center col-md-6" method="post">
		...
		<div class="card card__inner">
			...
			<p class="form-row">
				...
				<button type="submit" class="woocommerce-Button button button--primary" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
