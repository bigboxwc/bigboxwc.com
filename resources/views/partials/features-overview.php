		...
		<ul class="feature-list">
			...
			<li class="feature-item feature-item--mini col-lg-4">
				...
				<div class="feature-item__content">
					...
					<p><a href="/">Learn about filtering &rarr;</a></p>
				</div>
			</li>
			...
			<li class="feature-item feature-item--mini col-lg-4">
				...
				<div class="feature-item__content">
					...
					<p><a href="/">Learn about WooCommerce &rarr;</a></p>
				</div>
			</li>
			...
			<li class="feature-item feature-item--mini col-lg-4">
				...
				<div class="feature-item__content">
					...
					<p><a href="/">Learn about customization &rarr;</a></p>
				</div>
			</li>
			...
			<li class="feature-item feature-item--mini col-lg-4">
				...
				<div class="feature-item__content">
					...
					<p><a href="/">Learn about searching &rarr;</a></p>
				</div>
			</li>
